 ...
 */
public record GameRules(int startingPoints, int finalRoundWind, boolean redFives,
                        boolean openTanyao, boolean headBump, boolean endOnBankruptcy) {

    /** A half game to south four, the usual ruleset. */
    public static GameRules hanchan() {
        return new GameRules(25000, com.majong.riichi.core.Tiles.SOUTH, true, true, true, true);
    }

    /** A short game that ends after the east round. */
    public static GameRules tonpuusen() {
        return new GameRules(25000, com.majong.riichi.core.Tiles.EAST, true, true, true, true);
    }
}
