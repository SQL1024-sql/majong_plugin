 ...
 * @param targetPoints    points a player must reach for the game to be decided
 ...
 */
public record GameRules(int startingPoints, int targetPoints, int finalRoundWind,
    ...
    public static GameRules hanchan() {
        return new GameRules(25000, 30000, com.majong.riichi.core.Tiles.SOUTH,
                true, true, true, true);
    }

    /** A short game that ends after the east round. */
    public static GameRules tonpuusen() {
        return new GameRules(25000, 30000, com.majong.riichi.core.Tiles.EAST,
                true, true, true, true);
    }
}
